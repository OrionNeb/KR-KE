...
Unternehmen müssen Risiken in komplexen Geschäftsprozessen frühzeitig erkennen und bewerten. 
Klassische Methoden wie die FMEA sind zwar etabliert, stoßen jedoch an Grenzen, wenn Unsicherheiten oder 
domänenübergreifende Zusammenhänge zwischen Abteilungen berücksichtigt werden müssen.

## Zielsetzung {#sec-zielsetzung}
Diese Arbeit verfolgt das Ziel, ein wissensbasiertes Decision-Support-System (DSS) auf Grundlage der ISO 31000 zu entwickeln. 
Dabei soll Wissen aus Risikoanalysen mithilfe von *Knowledge Engineering* systematisch erfasst und durch Fuzzy-Logik 
um Unsicherheiten erweitert werden. So entsteht ein Ansatz, der Risiken nicht nur bewertet, sondern auch 
Handlungsempfehlungen ermöglicht.

**Forschungsfrage:**  
Wie kann Wissen aus Risikoanalysen mithilfe von Methoden des Knowledge Engineering in ein wissensbasiertes 
Decision-Support-System überführt werden, das Unsicherheiten berücksichtigt und priorisierte Handlungsempfehlungen liefert?

## Vorgehensweise {#sec-vorgehensweise}
Die Arbeit folgt dem CRISP-DM-Vorgehensmodell und trennt Theorie und Praxis klar voneinander. 
Kapitel [Theoretischer Rahmen und Grundlagen](#sec-theorie) legt das methodische Fundament, 
Kapitel [Umsetzung des Modells](#sec-umsetzung) beschreibt die praktische Anwendung mit Python 
und einem domänenübergreifenden FMEA-Datensatz.
